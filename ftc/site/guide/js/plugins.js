 ...
 * @modified: 2024-10-08
 * @modifier: 위상욱
 * @description: 디지털 정부서비스 UI/UX 가이드라인에 맞춰 수정, 접근성 관련 수정 진행중
 */
        ...
        renderCalendar: function(side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    html += '<td><button type="button" class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-title="' + 'r' + row + 'c' + col + '">' + calendar[row][col].date() + '</button></td>';
...
$(function() {
    ...
    //date - 기간(일주일, 1개월) 버튼 클릭시
    $('.btn-date-changer').on('click', function() {
        const dateRange = $(this).closest('.filter-form').find('.datepicker-input .datepicker').val();
        ...
        $(this).closest('.filter-form').find('.datepicker-input .datepicker').val(startDate.format('YYYY.MM.DD') + ' ~ ' + endDate.format('YYYY.MM.DD'));
    });
