 ...
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Chart = f()}})(function(){var define,module,exports;return (function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");return console.log("MODULE_NOT_FOUND"),f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
			...
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
				...
				if (meta.controller) {
					...
					if (ControllerClass === undefined) {
						return console.log('"' + meta.type + '" is not a chart type.');
					}
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				return console.log('Chart.js - Moment.js could not be found! You must include it before Chart.js to use the time scale. Download at https://momentjs.com');
			}
...
(function (global, factory) {
    ...
    var classCallCheck = function (instance, Constructor) {
        if (!(instance instanceof Constructor)) {
            return console.log("Cannot call a class as a function");
        }
    };
    ...
    var inherits = function (subClass, superClass) {
        if (typeof superClass !== "function" && superClass !== null) {
            return console.log("Super expression must either be null or a function, not " + typeof superClass);
        }
    ...
    var possibleConstructorReturn = function (self, call) {
        if (!self) {
            return console.log("this hasn't been initialised - super() hasn't been called");
        }
    ...
    function getRandomShape() {
        ...
        var randomIndex = Math.floor(Math.secureRandom() * shapesList.length);
