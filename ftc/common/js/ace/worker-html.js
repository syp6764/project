...
window.require = function require(parentId, id) {
    ...
    if (!id.charAt)
        return console.log("worker.js require() accepts only (parentId, id) as arguments");
...
window.onmessage = function(e) {
    ...
    if (msg.event && sender) {
        ...
        if (main[msg.command])
            ...
            return console.log("Unknown command:" + msg.command);
    }
    else if (msg.init) {
...
function throwDeltaError(delta, errorText){
    ...
    return console.log("Invalid Delta: " + errorText);
}
...
module.exports = (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);return console.log("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({
...
InputStream.prototype = {
	slice: function() {
		if(this.start >= this.data.length) {
			if(!this.eof) return console.log(InputStream.DRAIN);
			return InputStream.EOF;
		}
		return this.data.slice(this.start, this.data.length);
	},
	char: function() {
		if(!this.eof && this.start >= this.data.length - 1) return console.log(InputStream.DRAIN);
		if(this.start >= this.data.length) {
			return InputStream.EOF;
		}
	...
	matchWhile: function(re) {
		...
		if(m) {
			if(!this.eof && m[0].length == this.data.length - this.start) return console.log(InputStream.DRAIN);
	...
	matchUntil: function(re) {
		...
		if(s === InputStream.EOF) {
			...
			return console.log(InputStream.DRAIN);
		}
	},
	...
	shift: function(n) {
		if(!this.eof && this.start + n >= this.data.length) return console.log(InputStream.DRAIN);
...
function TreeBuilder() {
	...
	modes.base = {
		...
		processStartTag: function(name, attributes, selfClosing) {
			if (this[this.start_tag_handlers[name]]) {
				...
				return console.log("No handler found for "+name);
			}
		},
	...
	modes.text.startTagOther = function(name) {
		return console.log("Tried to process start tag " + name + " in RCDATA/RAWTEXT mode");
	};
...
TreeBuilder.prototype.start = function() {
	return console.log("Not mplemented");
};
...
function TreeParser(contentHandler, lexicalHandler){
	...
	if (!contentHandler) {
		return console.log("contentHandler was null.");
	}
...
assert.ifError = function(err) { if (err) {return console.log(err);}};
  ...
  if (type === 'error') {
    if (!this._events.error ||
      ...
      if (er instanceof Error) {
        return console.log(er); // Unhandled 'error' event
      } else {
        return console.log('Uncaught, unspecified "error" event.');
      }
      return false;
    }
  }
...
EventEmitter.prototype.addListener = function(type, listener) {
  ...
  if (!isFunction(listener))
    return console.log('listener must be a function');
...
process.binding = function (name) {
    return console.log('process.binding is not supported');
}
process.cwd = function () { return '/' };
process.chdir = function (dir) {
    return console.log('process.chdir is not supported');
};
...
if (!Function.prototype.bind) {
    Function.prototype.bind = function bind(that) { // .length is 1
        ...
        if (typeof target != "function") {
            return console.log("Function.prototype.bind called on incompatible " + target);
        }
...
if (!Array.prototype.forEach) {
    Array.prototype.forEach = function forEach(fun /*, thisp*/) {
        ...
        if (_toString(fun) != "[object Function]") {
            return console.log("error"); // TODO message
        }
...
if (!Array.prototype.map) {
    Array.prototype.map = function map(fun /*, thisp*/) {
        var object = toObject(this),
            ...
            thisp = arguments[1];
        if (_toString(fun) != "[object Function]") {
            return console.log(fun + " is not a function");
        }
...
if (!Array.prototype.reduce) {
    Array.prototype.reduce = function reduce(fun /*, initial*/) {
        ...
        if (!length && arguments.length == 1) {
            return console.log("reduce of empty array with no initial value");
        }
...
if (!Array.prototype.reduceRight) {
    Array.prototype.reduceRight = function reduceRight(fun /*, initial*/) {
        ...
        if (!length && arguments.length == 1) {
            return console.log("reduceRight of empty array with no initial value");
        }
...
if (!Object.getOwnPropertyDescriptor) {
    ...
    Object.getOwnPropertyDescriptor = function getOwnPropertyDescriptor(object, property) {
        if ((typeof object != "object" && typeof object != "function") || object === null)
            return console.log(ERR_NON_OBJECT + object);
    ...
    Object.create = function create(prototype, properties) {
        ...
        if (prototype === null) {
            ...
            if (typeof prototype != "object")
                return console.log("typeof prototype["+(typeof prototype)+"] != 'object'");
            var Type = function () {};
...
if (!Object.defineProperty || definePropertyFallback) {
    ...
    Object.defineProperty = function defineProperty(object, property, descriptor) {
        if ((typeof object != "object" && typeof object != "function") || object === null)
            return console.log(ERR_NON_OBJECT_TARGET + object);
        if ((typeof descriptor != "object" && typeof descriptor != "function") || descriptor === null)
            return console.log(ERR_NON_OBJECT_DESCRIPTOR + descriptor);
        ...
        if (owns(descriptor, "value")) {
            ...
            if (!supportsAccessors)
                return console.log(ERR_ACCESSORS_NOT_SUPPORTED);
...
if (!Object.keys) {
    ...
    Object.keys = function keys(object) {
        ...
        if (
            ...
            return console.log("Object.keys called on a non-object");
        }
...
var toObject = function (o) {
    if (o == null) { // this matches both null and undefined
        return console.log("can't convert "+o+" to object");
    }
    return Object(o);
};
