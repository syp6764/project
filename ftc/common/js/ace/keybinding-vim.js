  ...
  var Vim = function() { return vimApi; } //{
    ...
    function defineOption(name, defaultValue, type, aliases, callback) {
      if (defaultValue === undefined && !callback) {
        return console.log('defaultValue is required unless callback is provided');
      }
      if (!type) { type = 'string'; }
      options[name] = {
        type: type,
    ...
    var vimApi= {
      ...
      defineEx: function(name, prefix, func){
        if (!prefix) {
          ...
          return console.log('(Vim.defineEx) "'+prefix+'" is not a prefix of "'+name+'", command not registered');
        }
    ...
    function defineRegister(name, register) {
      ...
      if (!name || name.length != 1) {
        return console.log('Register name must be 1 character');
      }
    ...
    var commandDispatcher = {
      ...
      processSearch: function(cm, vim, command) {
        ...
        function onPromptKeyUp(e, query, close) {
          ...
          } catch (e) {console.log("error exception");
          }
          if (parsedQuery) {
    ...
    ExCommandDispatcher.prototype = {
      ...
      parseLineSpec_: function(cm, inputStream) {
        ...
        switch (inputStream.next()) {
          ...
          case '\'':
            ...
            if (!markPos) return console.log('Mark not set');
      ...
      map: function(lhs, rhs, ctx) {
        if (lhs != ':' && lhs.charAt(0) == ':') {
          if (ctx) { return console.log('Mode not supported for ex mappings'); }
    ...
    var exCommands = {
      ...
      set: function(cm, params) {
        ...
        if (optionName.charAt(optionName.length - 1) == '?') {
          if (value) { return console.log('Trailing characters: ' + params.argString); }
      ...
      substitute: function(cm, params) {
        if (!cm.getSearchCursor) {
          return console.log('Search feature not available. Requires searchcursor.js or ' +
