...
(function($) {
	$.fn.extend({
		...
		if (options.weekStart == 'Sun') {
			$('#' + uniqueId).append('<div class="monthly-day-title-wrap"><div>일요일</div><div>월요일</div><div>화요일</div><div>수요일</div><div>목요일</div><div>금요일</div><div>토요일</div></div><div class="monthly-day-wrap"></div>');
		} else if (options.weekStart == 'Mon') {
			$('#' + uniqueId).append('<div class="monthly-day-title-wrap"><div>월요일</div><div>화요일</div><div>수요일</div><div>목요일</div><div>금요일</div><div>토요일</div><div>일요일</div></div><div class="monthly-day-wrap"></div>');
		} else {
		...
		$(document.body).on('click', '#'+uniqueId+' a.monthly-day', function (e) {
			...
			if(options.mode == 'event' && options.eventList == true) {
				...
				$("a.monthly-day").css("background","#fff");//추가
				$(this).css("background","#eefbff");//추가
